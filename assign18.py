...
# Provide summary statistics (mean, median, minimum, maximum, standard deviation) of variables (categorical vs quantitative) such as- For example, if categorical variable is age groups and quantitative variable is income, then provide summary s
# tatistics of income grouped by the age groups.
...
# Load the dataset
house_data = pd.read_csv('C:/Users/saksh/OneDrive/Desktop/DSML PRACT. EXAM/House Data.csv')
